...
export default function Index() {
  const [currency, setCurrency] = useState<CurrencyRate>({ code: 'USD', symbol: '$', rate: 1 });
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600"> Train on Your Data</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Your public social media posts are being used to train AI models. Companies like OpenAI should pay you for this. We make it happen.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-4 md:gap-6">
            {platforms.map((platform, index) => (
              <Card key={platform.name} className={`relative overflow-hidden transition-all hover:shadow-lg ${platform.isHot ? 'ring-2 ring-orange-500 shadow-lg' : ''}`}>
                {platform.isHot && (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-500 text-sm">{platform.frequency}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-2xl md:text-3xl font-bold text-green-600">
                        {loading ? '$--' : formatCurrency(platform.payPerAccess)}
                      </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm">
                  Payments are calculated based on how frequently AI companies access your public posts for training. 
                  Reddit offers daily payments because of its high-value discussion format, while other platforms 
                  batch payments quarterly due to processing costs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Link your social media accounts securely to track AI company usage</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">We track when AI companies access your public data for training</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Receive payments directly to your account based on usage</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
              <p>&copy; 2024 FairDataUse.com. Making AI training fair for everyone.</p>
            </div>
          </div>
        </div>
      </footer>
